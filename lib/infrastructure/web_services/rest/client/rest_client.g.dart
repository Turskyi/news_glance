...
class _RestClient implements RestClient {
  ...
  Future<List<NewsArticleResponse>> getNews(
    ...
    final _options = _setStreamType<List<NewsArticleResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<NewsArticleResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<ConclusionResponse> getConclusion(ConclusionRequest news) async {
    ...
    final _options = _setStreamType<ConclusionResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ConclusionResponse _value;
    try {
      _value = ConclusionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
